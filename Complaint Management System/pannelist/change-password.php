...
{
$sql=mysqli_query($bd, "SELECT password FROM  pannelist where password='".md5($_POST['password'])."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update pannelist set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>Pannelist | Change Password</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Pannelist Change Password</h3>
							</div>
