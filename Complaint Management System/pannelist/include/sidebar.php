			...
			<li>
				...
				<ul id="togglePages" class="collapse unstyled">
					<li>
						...
						<?php
							$c = $_SESSION['college'];
							$rt = mysqli_query($bd, "SELECT * FROM tblcomplaints where status is null and category='$c'");
					...
					<li>
						...
						Pending Complaint
                   		<?php 
  							$status="in Process";
  							$c = $_SESSION['college'];                   
							$rt = mysqli_query($bd, "SELECT * FROM tblcomplaints where status='$status' and category='$c'");
							$num1 = mysqli_num_rows($rt);
							{
						?>
						<b class="label orange pull-right"><?php echo htmlentities($num1); ?></b>
