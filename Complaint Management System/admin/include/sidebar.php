<div class="span3">
	<div class="sidebar">
		...
		<ul class="widget widget-menu unstyled">
            <li><a href="category.php"><i class="menu-icon icon-tasks"></i> Add College </a></li>
            <li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Add Category </a></li>
            <li><a href="state.php"><i class="menu-icon icon-tasks"></i>Add State</a></li>
            <li><a href="pannelist.php"><i class="menu-icon icon-tasks"></i>Add Pannelist</a></li>                
        </ul><!--/.widget-nav-->
